...
<div className="shadow-md flex flex-col md:flex-row bg-gradient-to-r from-emerald-500 to-blue-500 rounded-lg overflow-hidden transition duration-500 ease-out transform hover:-translate-y-1 ">
      ...
      <form className="flex-auto p-6">
        <div className="flex flex-wrap">
          <h1 className="flex-auto text-xl sm:text-2xl font-bold tracking-wide uppercase">
            {name}
          </h1>
        ...
        <p className="text-sm text-white">{availability == "all" ? "🔓 Open For All Adventurers" : "🔓 Open For Family Members"}{availability == "family" ? <a href="https://join.co-x3.com/?utm_source=makeworkfun" target="_blank"><i className="fas fa-question-circle ml-1.5"/></a>:""}</p>
      </form>
    </div>
