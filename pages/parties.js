      ...
      <div className=" max-w-6xl mx-auto py-8 sm:pt-24 px-4 sm:px-6 lg:px-8 my-auto w-full flex flex-col">
        <div className="animate-fade-in-up bg-dailies-default rounded p-10 opacity-90">
          ...
          <div className="text-center">
            <section>
              <h2 className="text-4x1 font-bold text-dailies">Your Active Party</h2>
              <div className="max-w-lg bg-white shadow-md rounded-lg overflow-hidden mx-auto mt-2">
                <div className="py-4 px-8 mt-3">
                  <div className="flex flex-col mb-8">
                    ...
                    <p className="text-black">[progress bar]</p>
            ...
            <section>
              <h2 className="text-4x1 font-bold text-dailies mt-4">Parties Recruiting</h2>
            </section>
          </div>
        </div>
      </div>
