...
export default function terms({ metaBase, setMeta }) {
    // sets the meta tags

    useEffect(() => {
        const meta = {
            title: 'Terms Of Use - ' + metaBase.titleBase,
            description: 'Describes the rules you agree to when using our services. Last updated May 12, 2021.'
        }
        setMeta(meta)
    }, []);
                ...
                <section>
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Co-x3 ("Company," “we," “us," or “our”), concerning your access to and use of the https://makework.fun website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Singapore and have our registered office at My Mail Box No. 881609, Singapore 919191. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                            <br /><br />
                    ...
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            We care about data privacy and security. Please review our Privacy Policy: <span className="text-emerald-500 font-semibold"><Link href="/docs/privacy-policy" target="_blank">https://makework.fun/docs/privacy-policy.</Link></span> By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.
                        </p>
                    </div>
                    <div className='my-10'>
                        <h2 className="title-font sm:text-2xl text-xl mb-4 font-semibold text-left text-white">
                    ...
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            These Terms shall be governed by and defined following the laws of Singapore. Co-x3 and yourself irrevocably consent that the courts of Singapore shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
                        </p>
                    </div>
                    <div className='my-10'>
                        <h2 className="title-font sm:text-2xl text-xl mb-4 font-semibold text-left text-white">
