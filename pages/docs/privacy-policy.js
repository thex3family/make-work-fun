...
export default function privacy({ metaBase, setMeta }) {
    // sets the meta tags

    useEffect(() => {
        const meta = {
            title: 'Privacy Policy - ' + metaBase.titleBase,
            description: 'Describes how and why we might use your information when using our services. Last updated May 12, 2021.'
        }
        setMeta(meta)
    }, []);
                ...
                <section>
                    <div className='my-10'>
                        <p className="text-accents-6">
                            This privacy notice for Co-x3 ("Company," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
                            <br /><br />
                            <ul class="list-disc list-outside ml-5">
                                <li>Visit our website at https://makework.fun, or any website of ours that links to this privacy notice</li>
                                <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                            </ul>
                            <br />
                            Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at legal@co-x3.com.
                        </p>
                    </div>
                    <div className='my-10'>
                        <h2 className="title-font sm:text-2xl text-xl mb-4 font-semibold text-left text-white">
                            SUMMARY OF KEY POINTS
                        </h2>
                        This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by scrolling down to the section you are looking for.
                        <br /><br />
                        <p className="text-accents-6">
                            <b>What personal information do we process?</b> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Co-x3 and the Services, the choices you make, and the products and features you use.
                            <br /><br />
                            ...
                            <br /><br />
                            <b>In what situations and with which parties do we share personal information?</b> We may share information in specific situations and with specific third parties.
                            <br /><br />
                            ...
                            <br /><br />
                            <b>How do I exercise my rights?</b> The easiest way to exercise your rights is by contacting us at legal@co-x3.com. We will consider and act upon any request in accordance with applicable data protection laws.
                        </p>
                    </div>
                    <div className='my-10'>
                        <h2 className="title-font sm:text-2xl text-xl mb-4 font-semibold text-left text-white">
                        ...
                        <p className="text-accents-6">
                            ...
                            <br /><br />
                            <i>In Short: Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Services.</i>
                            <br /><br />
                            We automatically collect certain information when you visit, use, or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our Services, and other technical information. This information is primarily needed to maintain the security and operation of our Services, and for our internal analytics and reporting purposes.
                            <br /><br />
                            Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: <span className="text-emerald-500 font-semibold"><Link href="/docs/cookies" target="_blank">https://makework.fun/docs/cookies.</Link></span>
                            <br /><br />
                    ...
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            ...
                            <br /><br />
                            We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: https://makework.fun/docs/cookies.
                        </p>
                    </div>
                    <div className='my-10'>
                        <h2 className="title-font sm:text-2xl text-xl mb-4 font-semibold text-left text-white">
                        ...
                        <p className="text-accents-6">
                            <i>In Short: If you choose to register or log in to our services using a social media account, we may have access to certain information about you.</i>
                            <br /><br />
                    ...
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            <i>In Short: In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</i>
                            <br /><br />
                            ...
                            <br /><br />
                            Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. To opt out of interest-based advertising by advertisers on our Services visit http://www.aboutads.info/choices/. For further information, please see our Cookie Notice: <span className="text-emerald-500 font-semibold"><Link href="/docs/cookies" target="_blank">https://makework.fun/docs/cookies.</Link></span>
                            <br /><br />
                            If you have questions or comments about your privacy rights, you may email us at legal@co-x3.com.
                        </p>
                    </div>
                    <div className='my-10'>
                        <h2 className="title-font sm:text-2xl text-xl mb-4 font-semibold text-left text-white">
                    ...
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO), Conrad Lin, by email at legal@co-x3.com, by phone at +1 (855) 635-3835, or by post to:
                            <br /><br />
                            Co-x3
                            <br />
                            Conrad Lin
                            <br />
                            My Mail Box No. 881609
                            <br />
                            Singapore 919191
                        </p>
                    </div>
                    <div className='my-10'>
                        ...
                        <p className="text-accents-6">
                            Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please email legal@co-x3.com
                        </p>
                    </div>
                </section>
            </div>
