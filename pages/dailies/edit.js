...
function generateTable(dataSource, columns, EditableRowFunc, EditableCellFunc, handleAddFunc, handleSaveFunc) {
    ...
    <BottomNavbar/>
      <div className=" max-w-6xl mx-auto py-8 sm:pt-24 px-4 sm:px-6 lg:px-8 my-auto w-full flex flex-col">
        <div className="bg-dailies-default rounded p-10 opacity-95">
          ...
          <div className="text-center my-5">
            { habits ? generateTable(habits, columns, EditableRow, EditableCell, handleAdd, handleSave) : null }
          </div>
        </div>
      </div>
    </section>
